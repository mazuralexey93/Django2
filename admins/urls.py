...
from admins.views import index, UserListView, UserDeleteView, UserUpdateView, UserCreateView,\
    UserUnDeleteView, admin_categories, admin_categories_create, admin_categories_update, admin_categories_delete
